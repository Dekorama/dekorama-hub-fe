...
import { getMarketConfig, getMarketLabel, type MarketCode } from "@/shared/utils/market";
import { DEPARTMENT_LABELS, DepartmentType, PROJECT_TYPE_LABELS, ProjectType } from "@/features/projects/types";
