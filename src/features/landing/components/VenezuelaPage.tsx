...
import VenezuelaInitiative from "@/features/landing/components/VenezuelaInitiative";
...
export function VenezuelaPage() {
  return (
    ...
    >
      ...
      >
        <LandingNav variant="venezuela" />
        <VenezuelaInitiative />
        <LandingFooter variant="venezuela" />
      </Box>
    </Box>
  );
}
